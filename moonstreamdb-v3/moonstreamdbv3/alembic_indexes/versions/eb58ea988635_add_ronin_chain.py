...
Revision ID: eb58ea988635
Revises: 5ce23893771f
Create Date: 2024-11-11 17:11:09.701996
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("block_number", name=op.f("pk_ronin_sepolia_blocks")),
    )
    op.create_index(
        op.f("ix_ronin_sepolia_blocks_block_number"),
        "ronin_sepolia_blocks",
        ["block_number"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ronin_sepolia_blocks_block_timestamp"),
        "ronin_sepolia_blocks",
        ["block_timestamp"],
        unique=False,
    )
    op.create_table(
        "ronin_sepolia_reorgs",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("block_number", sa.BigInteger(), nullable=False),
        sa.Column("block_hash", sa.VARCHAR(length=256), nullable=False),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_ronin_sepolia_reorgs")),
    )
    op.create_index(
        op.f("ix_ronin_sepolia_reorgs_block_hash"),
        "ronin_sepolia_reorgs",
        ["block_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ronin_sepolia_reorgs_block_number"),
        "ronin_sepolia_reorgs",
        ["block_number"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("address", name=op.f("pk_ronin_sepolia_contracts")),
    )
    op.create_index(
        op.f("ix_ronin_sepolia_contracts_deployed_by"),
        "ronin_sepolia_contracts",
        ["deployed_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ronin_sepolia_contracts_deployed_bytecode_hash"),
        "ronin_sepolia_contracts",
        ["deployed_bytecode_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ronin_sepolia_contracts_name"),
        "ronin_sepolia_contracts",
        ["name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ronin_sepolia_contracts_transaction_hash"),
        "ronin_sepolia_contracts",
        ["transaction_hash"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_ronin_sepolia_contracts_transaction_hash"),
        table_name="ronin_sepolia_contracts",
    )
    op.drop_index(
        op.f("ix_ronin_sepolia_contracts_name"), table_name="ronin_sepolia_contracts"
    )
    op.drop_index(
        op.f("ix_ronin_sepolia_contracts_deployed_bytecode_hash"),
        table_name="ronin_sepolia_contracts",
    ...
    op.drop_table("ronin_sepolia_contracts")
    op.drop_index(
    ...
    op.drop_index(
        op.f("ix_ronin_sepolia_reorgs_block_number"), table_name="ronin_sepolia_reorgs"
    )
    op.drop_index(
        op.f("ix_ronin_sepolia_reorgs_block_hash"), table_name="ronin_sepolia_reorgs"
    )
    op.drop_table("ronin_sepolia_reorgs")
    op.drop_index(
        op.f("ix_ronin_sepolia_blocks_block_timestamp"),
        table_name="ronin_sepolia_blocks",
    )
    op.drop_index(
        op.f("ix_ronin_sepolia_blocks_block_number"), table_name="ronin_sepolia_blocks"
    )
    op.drop_table("ronin_sepolia_blocks")
