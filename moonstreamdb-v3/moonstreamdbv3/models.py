...
class EthereumLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_ethereum_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_ethereum_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
...
class SepoliaLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_sepolia_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_sepolia_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class PolygonLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_polygon_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_polygon_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class MumbaiLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_mumbai_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_mumbai_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class AmoyLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_amoy_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_amoy_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class XDaiLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_xdai_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_xdai_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class ZkSyncEraLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_zksync_era_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_zksync_era_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class ZkSyncEraSepoliaLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_zksync_era_sepolia_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_zksync_era_sepolia_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class BaseLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_base_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_base_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class ArbitrumNovaLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_arbitrum_nova_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_arbitrum_nova_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class ArbitrumOneLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_arbitrum_one_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_arbitrum_one_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class ArbitrumSepoliaLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_arbitrum_sepolia_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_arbitrum_sepolia_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class XaiLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_xai_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_xai_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class XaiSepoliaLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_xai_sepolia_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_xai_sepolia_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class AvalancheLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_avalanche_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_avalanche_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class AvalancheFujiLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_avalanche_fuji_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_avalanche_fuji_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class BlastLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_blast_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_blast_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class BlastSepoliaLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_blast_sepolia_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_blast_sepolia_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class ProofOfPlayApexLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_proofofplay_apex_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_proofofplay_apex_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class StarknetLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_starknet_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_starknet_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
...
class StarknetSepoliaLabel(EvmBasedLabel):  # type: ignore
    ...
    __table_args__ = (
        ...
        Index(
            'uk_starknet_sepolia_labels_transaction_hash_tx_call',
            'transaction_hash',
            unique=True,
            postgresql_where=text("label='seer' and label_type='tx_call'")
        ),
        Index(
            'uk_starknet_sepolia_labels_transaction_hash_log_index_event',
            'transaction_hash',
            'log_index',
            unique=True,
            postgresql_where=text("label='seer' and label_type='event'")
