...
ENGINE_DB_IDLE_SESSION_TIMEOUT_SECONDS_RAW = os.environ.get(
    "ENGINE_DB_IDLE_SESSION_TIMEOUT_SECONDS"
)
ENGINE_DB_IDLE_SESSION_TIMEOUT_SECONDS = 2 * ENGINE_DB_POOL_RECYCLE_SECONDS
try:
    if ENGINE_DB_IDLE_SESSION_TIMEOUT_SECONDS_RAW is not None:
        ENGINE_DB_IDLE_SESSION_TIMEOUT_SECONDS = int(
            ENGINE_DB_IDLE_SESSION_TIMEOUT_SECONDS_RAW
        )
except:
    raise ValueError(
        f"ENGINE_DB_IDLE_SESSION_TIMEOUT_SECONDS must be an integer: {ENGINE_DB_IDLE_SESSION_TIMEOUT_SECONDS_RAW}"
    )
