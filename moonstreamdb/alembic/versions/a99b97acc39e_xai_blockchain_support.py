...
def upgrade():
    ...
    op.create_index(
        op.f("ix_xai_blocks_block_number"), "xai_blocks", ["block_number"], unique=True
    )
    op.create_index(op.f("ix_xai_blocks_hash"), "xai_blocks", ["hash"], unique=False)
    op.create_index(
        op.f("ix_xai_blocks_timestamp"), "xai_blocks", ["timestamp"], unique=False
    )
    op.create_table(
        "xai_labels",
    ...
    op.create_index(
        op.f("ix_xai_labels_address"), "xai_labels", ["address"], unique=False
    )
    op.create_index(
        op.f("ix_xai_labels_block_number"), "xai_labels", ["block_number"], unique=False
    )
    op.create_index(
        op.f("ix_xai_labels_block_timestamp"),
        "xai_labels",
        ["block_timestamp"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_xai_labels_transaction_hash"),
        "xai_labels",
        ["transaction_hash"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["block_number"],
            ["xai_blocks.block_number"],
            name=op.f("fk_xai_transactions_block_number_xai_blocks"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("hash", name=op.f("pk_xai_transactions")),
    )
    op.create_index(
        op.f("ix_xai_transactions_block_number"),
        "xai_transactions",
        ["block_number"],
        unique=False,
    )
